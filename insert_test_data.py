...
db.leason.insert(week_day="Söndag",leason_time="13:00:00",leason_length=60,max_customers=6, skill_level=1,status="Active",leason_type="Ponny",limited="Ja",start_date="2013-11-24",end_date="2013-12-15")
...
db.leasons.insert(id_customer=1,id_leason=8)
...
db.owner_of_leason.insert(leason_id=8,instructor_id=1)
